package com.allen.loltool.widget.BottomMenu;
...
public class TabBottom extends LinearLayout implements View.OnClickListener {
    ...
    private static int mTabCount = 4;//设置tab的数量

    private LinearLayout mLinearLayout;

    private int img_drawable_Id[] = {
                    R.drawable.home_bottom_tab_information_selector,
                    R.drawable.home_bottom_tab_hero_selector,
                    R.drawable.home_bottom_tab_community_selector,
                    R.drawable.home_bottom_tab_more_selector};
    ...
    private void initImageView(Context context) {
       ...
       // mLinearLayout.setPadding(5, 10, 5, 10);
        mLinearLayout.setBackgroundColor(getResources().getColor(R.color.home_tab_bg));
